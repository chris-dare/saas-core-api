"""The :mod:`django_emr.models.patient` module contains ORMs used to persist and retrieve 
data concerning patients on Serenity's django backend app
"""
...
class PatientBase(TimeStampedModel):
    ...
    other_names: Optional[str] = Field(
        description="Patient's other names", nullable=False
    )
...
class Patient(PatientBase, TimeStampedModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("id", "mr_number", name="id_mr_number"),)
