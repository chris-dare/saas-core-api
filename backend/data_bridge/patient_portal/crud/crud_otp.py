...
from data_bridge.core.security import generate_otp_code
from data_bridge.core.config import settings
from data_bridge.patient_portal.crud.base import CRUDBase
from data_bridge.utils import ModeOfMessageDelivery, send_sms
...
class CRUDOtp(CRUDBase[models.OTP, models.OTPCreate, models.OTPRead]):
    ...
    async def send_otp(self,
        ...
        from data_bridge.patient_portal import crud
        if not otp:
