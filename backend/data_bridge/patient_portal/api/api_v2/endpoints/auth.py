...
from data_bridge.patient_portal.api import deps
from data_bridge.core import security
from data_bridge.core.config import settings
from data_bridge.exceptions import get_api_error_message, ErrorCode
...
async def verify_user_status(
    ...
    """Verifies whether a user is active or not"""
